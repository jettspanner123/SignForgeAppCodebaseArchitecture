...
public interface IConfigurationConstantService {
    ...
    ConfigurationConstantResponseDTO addDesignation(AddDesignationRequestDTO request, String updatedBy);

    ConfigurationConstantResponseDTO addDepartment(AddDepartmentRequestDTO request, String updatedBy);

    ConfigurationConstantResponseDTO addWorkLocation(AddWorkLocationRequestDTO request, String updatedBy);
}
